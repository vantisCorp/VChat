...
export class FeedbackManager {
  ...
  update(feedbackId: string, updates: Partial<FeedbackEntry>): FeedbackEntry {
    ...
    const { id: _id, createdAt: _createdAt, voters: _voters, ...allowedUpdates } = updates as any;
  ...
  updateSurvey(surveyId: string, updates: Partial<FeedbackSurvey>): FeedbackSurvey {
    ...
    // Prevent updating immutable fields
    const { id: _id, createdAt: _createdAt, responseCount: _responseCount, ...allowedUpdates } = updates as any;
